    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          ...
          content: Text('Device deleted successfully!', style: TextStyle(color: Colors.white)),
                  ...
                  Row(
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: Text('Custom', style: GoogleFonts.poppins(color: Colors.white)),
                      ),
                    ],
                  ),
                ],
                              ...
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('Power: ${power.toStringAsFixed(2)} kW',
                                        style: GoogleFonts.poppins(color: isDarkTheme ? Colors.blue[300] : Colors.blue[700], fontSize: 13)),
                                    Text('Usage: ${usage.toStringAsFixed(1)} hrs/day',
                                        style: GoogleFonts.poppins(color: isDarkTheme ? Colors.blue[300] : Colors.blue[700], fontSize: 13)),
                                    Text('Daily Consumption: ${_formatEnergyValue(dailyConsumption)}',
                                        style: GoogleFonts.poppins(color: isDarkTheme ? Colors.blue[300] : Colors.blue[700], fontSize: 13)),
                                  ],
                                ),
                                trailing: Row(
                                      ...
                                      onPressed: () {
                                        ...
                                        showDialog(
                                          ...
                                          builder: (context) => AlertDialog(
                                            ...
                                            content: Text(
                                              'Are you sure you want to delete ${device['manufacturer'] ?? 'Unknown'} ${device['model'] ?? ''}?',
                                                  ...
                                                  if (deviceId.isNotEmpty) {
                                                    ...
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      const SnackBar(
                                                        ...
                                                        content: Text('Error: Device ID not found', style: TextStyle(color: Colors.white)),
                                                      ),
                                                    );
                                                  }
                                                },
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            backgroundColor: Colors.green, 
            content: Text('Device added successfully!', style: TextStyle(color: Colors.white)),
            duration: Duration(seconds: 1),
          ),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            backgroundColor: Colors.red, 
            content: Text('Error saving device: $e', style: const TextStyle(color: Colors.white)),
            duration: const Duration(seconds: 1),
          ),
        );
      }
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                hint: Text('Select Manufacturer', style: GoogleFonts.poppins(color: isDarkTheme ? Colors.white70 : Colors.black54)),
              ...
              DropdownButtonFormField<String>(
                ...
                hint: Text('Select Model', style: GoogleFonts.poppins(color: isDarkTheme ? Colors.white70 : Colors.black54)),
      ...
      actions: [
        TextButton(
          onPressed: () => Navigator.of(context).pop(),
          child: Text('Cancel', style: GoogleFonts.poppins(color: isDarkTheme ? Colors.white70 : Colors.black54)),
        ),
        ElevatedButton(
          onPressed: _saveDevice,
          style: ElevatedButton.styleFrom(backgroundColor: Colors.blueAccent),
          child: Text('Add Device', style: GoogleFonts.poppins(color: Colors.white)),
        ),
      ],
    );
  }
    ...
    if (_customFormKey.currentState!.validate()) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            backgroundColor: Colors.green, 
            content: Text('Custom device added successfully!', style: TextStyle(color: Colors.white)),
            duration: Duration(seconds: 1),
          ),
        );
        Navigator.of(context).pop();
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            backgroundColor: Colors.red, 
            content: Text('Error saving custom device: $e', style: const TextStyle(color: Colors.white)),
            duration: const Duration(seconds: 1),
          ),
        );
      }
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(backgroundColor: Colors.blueAccent),
          child: Text('Add Custom Device', style: GoogleFonts.poppins(color: Colors.white)),
        ),
      ],
    );
  }
    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            backgroundColor: Colors.green,
            content: Text('Device updated successfully!', style: TextStyle(color: Colors.white)),
            duration: Duration(seconds: 1),
          )
        );
        if (!mounted) return;
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(backgroundColor: Colors.blueAccent),
          child: Text('Update Device', style: GoogleFonts.poppins(color: Colors.white)),
        ),
      ],
    );
  }
